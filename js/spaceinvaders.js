...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("404 Error", game.width / 2, game.height/2 - 40); 
    ctx.font="16px Arial";

    ctx.fillText("Defeat the invaders by pressing 'space' or touching the sceeen!.", game.width / 2, game.height/2); 
};
